...
var HousingsComponent = /** @class */ (function () {
    ...
    HousingsComponent = __decorate([
        core_1.Component({
            selector: 'housings',
            templateUrl: './app/components/housings/housings.component.html',
        }),
        __metadata("design:paramtypes", [housing_services_1.HousingService])
    ], HousingsComponent);
    return HousingsComponent;
}());
exports.HousingsComponent = HousingsComponent;
